...
const KEYS = new Set([
  ...
  'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET', 'STRIPE_CONNECT_WEBHOOK_SECRET', 'ANTHROPIC_API_KEY',
  'NOTA_OUTLOOK_CLIENT_SECRET', 'NOTA_CALENDAR_ENCRYPTION_KEY',
  'NOTA_OAUTH_ENCRYPTION_KEY', 'NOTA_OAUTH_GOOGLE_CLIENT_SECRET',
  'NOTA_OAUTH_MICROSOFT_CLIENT_SECRET', 'NOTA_OAUTH_LINKEDIN_CLIENT_SECRET',
]);
