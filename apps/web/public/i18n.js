...
(function (root, factory) {
  ...
  var TEXT = {
    ...
    "Un rendez-vous à distance qui garde l’essentiel : se voir, comprendre le document et avancer ensemble.": "A remote appointment that keeps what matters: seeing each other, understanding the document and moving forward together.",
    ...
    "La bêta utilise un document fictif. Elle ne signe aucun acte notarié et ne déclenche aucun paiement. La signature officielle reste à venir, après validation et intégration du fournisseur autorisé.": "The beta uses a fictional document. It does not sign any notarial deed or trigger a payment. Official signing is coming later, following validation and integration of the authorized provider.",
    ...
    "La préparation assistée est gratuite pendant la bêta. Nota améliore actuellement un système spécialisé — modèle, instructions et algorithmes propriétaires — à partir de données contrôlées et de révisions professionnelles.": "Assisted preparation is free during the beta. Nota is currently improving a specialized system — model, instructions and proprietary algorithms — from controlled data and professional reviews.",
    "La bêta pourra évoluer vers un abonnement pour notaires; aucun prix ni échéance n’est fixé. Les documents transmis pour votre dossier ne servent pas à entraîner les modèles.": "The beta may evolve into a subscription for notaries; no price or date has been set. Documents submitted for your case are not used to train the models.",
    ...
    "Connecteurs du dossier": "File connectors",
    "Le dossier de préparation et les connecteurs de Nota restent masqués jusqu’au paiement du service.": "The preparation file and Nota connectors remain hidden until the service is paid.",
    "Ce modèle a été généré à la réservation et débloqué après le paiement du service.": "This template was generated at booking and unlocked after the service was paid.",
    "Préparation automatique seulement": "Preparation only; no automatic decision",
  ...
  "Certains champs de collecte sont préparés par le dossier et le notaire sans extraction automatique : ": "Some intake fields are prepared by the case file and notary without automatic extraction: ",
    ...
    "La connexion avec Microsoft arrive bientôt. D’ici là, votre courriel suffit.": "Microsoft sign-in is coming soon. Until then, your email is all you need.",
  ...
  "Aucune offre ne correspond aux filtres sélectionnés.": "No offers match the selected filters.",
  "Aucune cote n’est encore disponible. Elle s’affichera après les premières données de votre activité.": "No score is available yet. It will appear after your first activity data is recorded.",
  "Aucun service n’est encore associé à votre historique.": "No service is associated with your history yet.",
  "Acte": "Act",
  "Montant": "Amount",
  "Statut": "Status",
  ...
  "Palette de couleurs": "Colour palette",
  "Ardoise": "Slate",
  "Marine": "Navy",
  "Sapin": "Fir",
  "Prune": "Plum",
  ...
  "Gardez le fil au même endroit, de votre première offre jusqu’à la signature.": "Keep everything in one place, from your first offer through signing.",
  ...
  "Courtiers immobiliers, courtiers hypothécaires, comptables et planificateurs : vos clients ont besoin d’un notaire à un moment précis. Référez-les à ce moment-là — chaque mise en relation qui aboutit est récompensée.": "Real-estate brokers, mortgage brokers, accountants and financial planners: your clients need a notary at one precise moment. Refer them at that moment — every introduction that goes through is rewarded.",
  "Vous êtes…": "You are…",
  "Le bon moment pour référer dépend de votre métier — choisissez le vôtre.": "The right moment to refer depends on your profession — pick yours.",
  ...
  "Le versement suit la signature de l’acte — une demande annulée avant ne donne lieu à aucun versement.": "Payment follows the signing of the act — a request cancelled before then earns no payment.",
  "Les récompenses": "The rewards",
  "Référez un client": "Refer a client",
  "Acquise dès qu’un notaire retient la demande ; versée une fois l’acte signé.": "Earned as soon as a notary takes on the request; paid once the act is signed.",
  "Sans limite": "No limit",
  "Référez un notaire": "Refer a notary",
  "Acquise à son premier acte retenu ; versée une fois cet acte signé.": "Earned at their first retained act; paid once that act is signed.",
  ...
  "Remplir ma semaine": "Fill my week",
    "Explorer le carnet →": "Explore the marketplace →",
  "Passer →": "Skip →",
  "Nota": "Nota",
...
"Bonjour ! Pour votre refinancement ou votre financement hypothécaire, vous pouvez choisir votre date de signature et voir le prix avant de vous engager, sur Nota. Le notaire reçoit 100 % de votre offre et vous ne payez qu’à la signature. Voici le lien : ": "Hello! For your mortgage refinancing or financing, you can pick your signing date and see the price before committing, on Nota. The notary receives 100 % of your offer and you only pay at signing. Here is the link: ",
  ...
  "Au repos, vos données sont conservées sur des serveurs canadiens (Amazon Web Services, région <strong>ca-central-1</strong>, Montréal). En transit, elles passent par un réseau de diffusion dont les points de présence sont aussi aux États-Unis et en Europe, et par des prestataires tiers : Stripe pour le paiement, rsms.me et Google Fonts pour les polices de caractères.": "At rest, your data is stored on Canadian servers (Amazon Web Services, <strong>ca-central-1</strong> region, Montréal). In transit it passes through a content delivery network whose edge locations are also in the United States and Europe, and through third-party providers: Stripe for payment, rsms.me and Google Fonts for the typefaces.",
