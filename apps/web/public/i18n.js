...
(function (root, factory) {
  ...
  var TEXT = {
    ...
    'Précédent': 'Back',
    'Suivant': 'Forward',
    'Notre façon de construire': 'How we build',
    'Une idée. Une boucle complète. Un produit qui apprend.': 'One idea. One complete loop. A product that learns.',
    'Chaque fonctionnalité suit le même cycle : planifier, choisir, tester, livrer, écouter et améliorer. Rien ne passe à l’étape suivante sans notre définition de fini.': 'Every feature follows the same cycle: plan, choose, test, ship, listen and improve. Nothing moves forward without our definition of done.',
    'Mettre l’animation en pause': 'Pause animation',
    'Reprendre l’animation': 'Resume animation',
    'Boucle de développement : concept, plan, technologie, tests, sécurité, CI/CD, production, feedback et amélioration des modèles': 'Development loop: concept, plan, technology, testing, security, CI/CD, production, feedback and model improvement',
    'La petite boucle des modèles est testée localement, puis en bêta, avant de rejoindre la grande boucle.': 'The models’ inner loop is tested locally, then in beta, before joining the larger loop.',
