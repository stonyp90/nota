...
| --- | --- | --- | --- |
| **Grille de prix par service** — ADR 0034 | Le prix de Nota cesse d'être un montant unique. Au prix unique de 400 $, Nota pesait **18,2 %** d'un financement de 1 800 $, **16,7 %** d'un refinancement de 2 000 $ et **9 %** d'un acte à 4 000 $ : régressif, il frappait le plus petit dossier le plus fort. **Livré :** 229 $ financement, 279 $ refinancement (ADR 0042), garantie de date de 0 à 549 $ sur sa propre ligne (ADR 0038). Poids mesuré : **11,3 %** (229 / 2 029) et **12,2 %** (279 / 2 279) au standard, **8,8 %** au prioritaire. Ne dépend d'aucune cote — l'art. 29.1 reste satisfait. | **Notairo**, dont le produit équivalent (« frais de prise en charge de dossier ») est à **295 $**. Au prix unique, Nota était 35 % au-dessus (400 contre 295) ; **la grille l'a fait passer dessous** : 279 / 295 = −5,4 %, 229 / 295 = −22,4 %. Écart fermé sans toucher aux honoraires du notaire. Comparaison interne — jamais écrite à un client (art. 32.1 1°). | **livré (2026-09-03)** |
...
entrée sans mot de passe · cote sur 100 visible au notaire dans sa propre
console (outil interne : elle ne décide d'aucun partage — il n'y en a plus,
ADR 0031 — et ne s'affiche jamais au client) · la déontologie d'abord : aucune
cote publiée sur un notaire nommé (ADR 0030).
