...
resource "aws_acm_certificate" "cert" {
  count    = var.domain_name == "" && var.plan_domain_name == "" && var.pitch_domain_name == "" ? 0 : 1
  ...
  domain_name       = var.domain_name != "" ? var.domain_name : (var.plan_domain_name != "" ? var.plan_domain_name : var.pitch_domain_name)
...
resource "aws_route53_record" "cert_validation" {
  for_each = var.domain_name == "" && var.plan_domain_name == "" && var.pitch_domain_name == "" ? {} : {
