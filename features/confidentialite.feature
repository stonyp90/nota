...
Fonctionnalité: Confidentialité de l'enchère
  ...
  Scénario: une enchère anonyme masque le nom mais montre le préfixe
    Quand je publie une enchère anonyme au nom de "Marie Tremblay" avec préfixe "G1R" pour "testament" le "2026-08-20" à 1400
  ...
  Scénario: une enchère nominative affiche le nom
    Quand je publie une enchère nominative au nom de "Luc Gagné" avec préfixe "G2B" pour "procuration" le "2026-08-20" à 900
    Alors la réponse a le statut 201
