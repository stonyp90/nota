...
Fonctionnalité: Validation d'offre via l'API
  ...
  Scénario: une date mal formée est refusée
    Quand je publie une enchère pour "testament" le "pas-une-date" à 1400
