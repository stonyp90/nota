...
Fonctionnalité: Cycle de vie des notifications
  ...
  Scénario: publier une offre avec courriel notifie le client et l'opérateur
    Quand un client publie une offre avec le courriel "client@exemple.ca" pour "testament" à 1400 dans 10 jours
  ...
  Scénario: publier une offre sans courriel réussit sans tenter d'email client
    Quand un client publie une offre sans courriel pour "testament" à 1400 dans 10 jours
    Alors la réponse a le statut 201
  ...
  Scénario: un rappel est dû à 3 jours de la signature
    Étant donné une offre ouverte avec le courriel "relance@exemple.ca" pour "testament" à 1400 dans 3 jours
  ...
  Scénario: aucun rappel n'est dû à 4 jours de la signature
    Étant donné une offre ouverte avec le courriel "loin@exemple.ca" pour "testament" à 1400 dans 4 jours
    Quand le planificateur de rappels s'exécute
